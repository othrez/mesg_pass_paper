...
%
Columns of both the tables should be interpreted as follows :

\begin{inparaenum}
\item {\bf P} lists the name of protocol under analysis.
...
in the \texttt{MPass\_result} folder which is inside the \texttt{MPass-master} directory.
