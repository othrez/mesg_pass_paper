...
%
All (faulty) examples listed in \Cref{tbl:experiments_f} on the other hand, have been proved to be unsafe in less than two seconds and within less than three phases.
