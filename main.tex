...
\newcommand{\settings}{\texttt{Settings}}
...
\newcommand{\Lcs}{\textsc{Lcs}}
\newcommand{\Slcs}{\textsc{Slcs}}
\newcommand{\Ucs}{\textsc{Ucs}}

\newcommand{\Fifo}{\textsc{Fifo}}

\newcommand{\Nfa}{\textsc{Nfa}}

\newcommand{\Abp}{\textsc{Abp}}
\newcommand{\Brp}{\textsc{Brp}}
\newcommand{\Stp}{\textsc{Stp}}
\newcommand{\AbpF}{\textsc{Abp\_F}}
\newcommand{\SlideF}{\textsc{SlidingWindow\_F}}
\newcommand{\SynchF}{\textsc{Synchronous\_F}}

\newcommand{\Scc}{\textsc{Scc}}

\newcommand{\alternator}{\textsc{alternator}}

\newcommand{\sccin}{$s_{\Scc}^{in}$}
\newcommand{\sccout}{$s_{\Scc}^{out}$}
...
\author{Parosh Aziz Abdulla\inst{1} \and Mohamed Faouzi Atig\inst{1} \and Jonathan Cederberg\inst{1} \and Subham Modi\inst{3} \and Othmane Rezine\inst{1} \and Gaurav Saini\inst{2}  }
